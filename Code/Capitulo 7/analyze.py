...
def count_words(text):
    """This function counts the number of words in a string, using split() and len()"""
    words = text.split()
...
def compute_readability(text):
    """This function takes a text string of any length and prints out a grade-based readability score."""
    total_words = 0
    total_sentences = 0
    total_syllables = 0
    score = 0
